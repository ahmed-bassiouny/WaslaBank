package bassiouny.ahmed.wasllabank.api;
...
import bassiouny.ahmed.wasllabank.api.apiModel.requests.AcceptRejectUser;
import bassiouny.ahmed.wasllabank.api.apiModel.requests.ChangePasswordRequest;
import bassiouny.ahmed.wasllabank.api.apiModel.requests.ContactUsRequest;
...
import bassiouny.ahmed.wasllabank.api.apiModel.requests.FinishTripRequest;
import bassiouny.ahmed.wasllabank.api.apiModel.requests.StartTripRequest;
import bassiouny.ahmed.wasllabank.api.apiModel.requests.TripDetailsRequest;
import bassiouny.ahmed.wasllabank.api.apiModel.requests.TripStatusRequest;
import bassiouny.ahmed.wasllabank.api.apiModel.requests.TripsByDate;
import bassiouny.ahmed.wasllabank.api.apiModel.response.AboutResponse;
import bassiouny.ahmed.wasllabank.api.apiModel.response.GenericResponse;
import bassiouny.ahmed.wasllabank.api.apiModel.response.NotificationResponse;
import bassiouny.ahmed.wasllabank.api.apiModel.response.ParentResponse;
...
import bassiouny.ahmed.wasllabank.api.apiModel.response.TripDetailsListResponse;
import bassiouny.ahmed.wasllabank.api.apiModel.response.TripDetailsResponse;
import bassiouny.ahmed.wasllabank.api.apiModel.response.UserInfoResponse;
import bassiouny.ahmed.wasllabank.api.apiModel.response.UserResponse;
