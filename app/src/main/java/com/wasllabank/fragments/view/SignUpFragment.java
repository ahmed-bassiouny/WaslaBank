...
import com.wasllabank.fragments.controller.SignUpController;
...
public class SignUpFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.wasllabank.R.layout.fragment_sign_up, container, false);
    }
    ...
    private void findView(View view) {
        etName = view.findViewById(com.wasllabank.R.id.et_name);
        etPhone = view.findViewById(com.wasllabank.R.id.et_phone);
        etEmail = view.findViewById(com.wasllabank.R.id.et_email);
        etPassword = view.findViewById(com.wasllabank.R.id.et_password);
        etConfirmPassword = view.findViewById(com.wasllabank.R.id.et_confirm_password);
        btnNext = view.findViewById(com.wasllabank.R.id.btn_next);
                    ...
                    getController().checkEmailAndPhone(etEmail.getText().toString(),
                            etPhone.getText().toString(), new BaseResponseInterface() {
                                ...
                                public void onSuccess(Object o) {
                                    ...
                                    loading(false);
                                    // open next screen
                                    MyUtils.openFragment(com.wasllabank.R.id.container, getActivity(), new SignUpCarFragment(), true, null);
                                }
