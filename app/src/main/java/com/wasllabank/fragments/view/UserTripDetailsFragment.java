...
import com.wasllabank.activities.view.ShowUserProfileActivity;
import com.wasllabank.model.TripDetails;

import java.util.List;

import com.wasllabank.adapter.UsersTripDetailsItem;
...
public class UserTripDetailsFragment extends Fragment implements ObserverInterface<TripDetails>, UserTripDetailsInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.wasllabank.R.layout.fragment_user_trip_details, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(com.wasllabank.R.id.swipe);
