...
import com.wasllabank.fragments.controller.RequestsController;
...
public class RequestsFragment extends Fragment implements ItemClickInterface<Integer> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.wasllabank.R.layout.fragment_requests, container, false);
    }
    ...
    private void findView(View view) {
        ...
        calendarView = view.findViewById(com.wasllabank.R.id.calendarView);
