...
import com.wasllabank.fragments.controller.SignUpUserDetailsController;
import com.wasllabank.interfaces.BaseResponseInterface;
import com.wasllabank.utils.Constant;
...
public class SignUpUserDetailsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.wasllabank.R.layout.fragment_sign_up_user_details, container, false);
    }
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etIdentifyNumber.getText().toString().length() != 14) {
                    etIdentifyNumber.setError(getString(com.wasllabank.R.string.invalid_identify_number));
                } else {
                    loading(true);
    ...
    private void findView(View view) {
        linearCities = view.findViewById(com.wasllabank.R.id.linear_cities);
        spCities = view.findViewById(com.wasllabank.R.id.sp_cities);
        ivAvatar = view.findViewById(com.wasllabank.R.id.iv_avatar);
        etIdentifyNumber = view.findViewById(com.wasllabank.R.id.et_identify_number);
        rbMale = view.findViewById(com.wasllabank.R.id.rb_male);
        btnSignUp = view.findViewById(com.wasllabank.R.id.btn_sign_up);
        progress = view.findViewById(com.wasllabank.R.id.progress);
