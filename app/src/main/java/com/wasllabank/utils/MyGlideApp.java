...
public class MyGlideApp {
    ...
    public static void setImage(Context context, ImageView image, String url) {
        if (checkValideData(context, url, image))
            Glide.with(context).load(url)
                    .apply(new RequestOptions().placeholder(com.wasllabank.R.drawable.person).error(com.wasllabank.R.drawable.person).dontAnimate())
                    .into(image);
    }
    ...
    public static void setImageCenterCrop(Context context, ImageView image, String url) {
        if (checkValideData(context, url, image))
            Glide.with(context).load(url)
                    .apply(new RequestOptions().placeholder(com.wasllabank.R.drawable.person).error(com.wasllabank.R.drawable.person).dontAnimate().centerCrop())
                    .into(image);
    }
    ...
    public static void setImageCenterInside(Context context, ImageView image, String url) {
        if (checkValideData(context, url, image))
            Glide.with(context).load(url)
                    .apply(new RequestOptions().placeholder(com.wasllabank.R.drawable.person).error(com.wasllabank.R.drawable.person).dontAnimate().centerInside())
                    .into(image);
