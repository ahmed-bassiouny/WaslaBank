...
import com.wasllabank.activities.controller.EditProfileController;
...
public class EditProfileActivity extends MyToolbar {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wasllabank.R.layout.activity_edit_profile);
        // set title toolbar
        initToolbar(getString(com.wasllabank.R.string.edit_profile),true);
        addBackImage();
        addSupportActionbar();
        findView();
        onClick();
                    ...
                    getController().editProfile(image,user.getId(), etName.getText().toString(), etInteresting.getText().toString(), new BaseResponseInterface<User>() {
                        ...
                        public void onSuccess(User user) {
                            ...
                            */SharedPrefManager.setObject(SharedPrefKey.USER, user);
                            Toast.makeText(EditProfileActivity.this, getText(com.wasllabank.R.string.profile_updated), Toast.LENGTH_SHORT).show();
                            loading(false);
                        }
    ...
    private void findView() {
        ...
        etInteresting = findViewById(com.wasllabank.R.id.et_interesting);
        btnUpdate = findViewById(com.wasllabank.R.id.btn_update);
        btnChangePassword = findViewById(com.wasllabank.R.id.btn_change_password);
