...
import com.wasllabank.fragments.view.AboutFragment;
...
public class UserProfileActivity extends MyToolbar implements MyObserverInterface<UserInfo> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wasllabank.R.layout.activity_user_profile);
        // set tool bar title
        initToolbar("",false);
    ...
    private void onClick() {
        findViewById(com.wasllabank.R.id.tv_order_name).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void findView() {
        ...
        tvOrder = findViewById(com.wasllabank.R.id.tv_order);
        viewStubProgress = findViewById(com.wasllabank.R.id.view_stub_progress);
        imgCover = findViewById(com.wasllabank.R.id.img_cover);
    ...
    private ImageView editImage() {
        ...
        // back image view src
        edit.setImageDrawable(getResources().getDrawable(com.wasllabank.R.drawable.ic_edit));
        // add tint mode
