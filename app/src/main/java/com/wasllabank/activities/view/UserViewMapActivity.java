...
public class UserViewMapActivity extends MyToolbar implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wasllabank.R.layout.activity_user_view_map);
        // init tool bar
        initToolbar("", false);
        addBackImagePrimary();
        addSupportActionbar();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot item : dataSnapshot.getChildren()) {
                    ...
                    if (location != null && googleMap != null && markerOptions.getPosition() != null) {
                        ...
                        userMarker = googleMap.addMarker(markerOptions);
                        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(com.wasllabank.R.drawable.car_marker)).position(new LatLng(location.getCurrentLat(), location.getCurrentLng())));
                    }
                }
            }
