...
public class HomeMenuItem extends RecyclerView.Adapter<HomeMenuItem.GridViewHolder> {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = mLayoutInflater.inflate(com.waslla_bank.R.layout.item_home_menu, parent, false);
    ...
    protected class GridViewHolder extends RecyclerView.ViewHolder {
        ...
        public GridViewHolder(View itemView) {
            super(itemView);
            tvMenu = itemView.findViewById(com.waslla_bank.R.id.tv_menu);
            ivMenu = itemView.findViewById(com.waslla_bank.R.id.iv_menu);
