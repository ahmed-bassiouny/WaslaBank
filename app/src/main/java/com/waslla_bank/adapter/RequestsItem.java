...
public class RequestsItem extends RecyclerView.Adapter<RequestsItem.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            rating = view.findViewById(com.waslla_bank.R.id.rating);
            tvLocationFrom = view.findViewById(com.waslla_bank.R.id.tv_location_from);
            tvLocationTo = view.findViewById(com.waslla_bank.R.id.tv_location_to);
            ivMap = view.findViewById(com.waslla_bank.R.id.iv_map);
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.waslla_bank.R.layout.item_request, parent, false);
