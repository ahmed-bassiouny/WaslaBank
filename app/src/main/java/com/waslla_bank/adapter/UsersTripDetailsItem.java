...
public class UsersTripDetailsItem extends RecyclerView.Adapter<UsersTripDetailsItem.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            tvUserPhone = view.findViewById(com.waslla_bank.R.id.tv_user_phone);
            tvAccept = view.findViewById(com.waslla_bank.R.id.tv_accept);
            tvReject = view.findViewById(com.waslla_bank.R.id.tv_reject);
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.waslla_bank.R.layout.item_users_trip_details, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (userInTrip.isLoading()) {
            ...
            holder.tvAccept.setVisibility(View.INVISIBLE);
            holder.tvReject.setText(fragment.getContext().getString(com.waslla_bank.R.string.accepted));
            holder.tvReject.setTextColor(fragment.getContext().getResources().getColor(com.waslla_bank.R.color.green));
        } else {
            // user waiting driver reply
            holder.viewStubProgress.setVisibility(View.GONE);
            holder.tvReject.setVisibility(View.VISIBLE);
            holder.tvAccept.setText(fragment.getContext().getString(com.waslla_bank.R.string.accept));
            holder.tvAccept.setTextColor(fragment.getContext().getResources().getColor(com.waslla_bank.R.color.colorPrimary));
        }
    }
