...
public class FeedbackItem extends RecyclerView.Adapter<FeedbackItem.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            ratingBar = view.findViewById(com.waslla_bank.R.id.rating);
            tvComment = view.findViewById(com.waslla_bank.R.id.tv_comment);
        }
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.waslla_bank.R.layout.item_feedback, parent, false);
