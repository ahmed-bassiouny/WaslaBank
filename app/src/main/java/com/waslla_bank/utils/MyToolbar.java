...
import com.waslla_bank.activities.view.NotificationActivity;
import com.waslla_bank.activities.view.UserProfileActivity;
...
public class MyToolbar extends AppCompatActivity {
    ...
    public void initToolbar(String toolbarTitle,boolean supportBackground) {
        toolbar = findViewById(com.waslla_bank.R.id.toolbar);
        // create frame layout
        ...
        if(supportBackground)
            toolbar.setBackground(getResources().getDrawable(com.waslla_bank.R.drawable.toolbar));
        ...
        // change text color
        title.setTextColor(getResources().getColor(com.waslla_bank.R.color.white));
        // text size
    ...
    public void addBackImage(){
        ...
        // back image view src
        back.setImageDrawable(getResources().getDrawable(com.waslla_bank.R.drawable.ic_arrow_back));
        // add tint mode
    ...
    public void addProfileImage(){
        ...
        // back image view src
        profile.setImageDrawable(getResources().getDrawable(com.waslla_bank.R.drawable.ic_person));
        // add tint mode
    ...
    public void addNotificationImage(){
        ...
        notification.setImageDrawable(getResources().getDrawable(com.waslla_bank.R.drawable.ic_notifications_none));
        // handle click item
