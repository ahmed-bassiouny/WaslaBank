...
public class AboutFragment extends Fragment implements ObserverInterface<User> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.waslla_bank.R.layout.fragment_about, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvAbout = view.findViewById(com.waslla_bank.R.id.tv_about);
        tvPhone = view.findViewById(com.waslla_bank.R.id.tv_phone);
        tvEmail = view.findViewById(com.waslla_bank.R.id.tv_email);
        tvCarNumber = view.findViewById(com.waslla_bank.R.id.tv_car_number);
    }
