...
import com.waslla_bank.activities.view.CancelTripActivity;
import com.waslla_bank.activities.view.DriverViewMapActivity;
import com.waslla_bank.activities.view.UserViewMapActivity;
import com.waslla_bank.fragments.controller.TripDetailsController;
...
import com.waslla_bank.utils.LocationManager;
...
public class TripDetailsFragment extends Fragment implements ObserverInterface<TripDetails>, LocationListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.waslla_bank.R.layout.fragment_trip_details, container, false);
    }
    ...
    private void findView(View view) {
        tvFrom = view.findViewById(com.waslla_bank.R.id.tv_from);
        tvTo = view.findViewById(com.waslla_bank.R.id.tv_to);
        tvAvailablePlaces = view.findViewById(com.waslla_bank.R.id.tv_available_places);
        tvDate = view.findViewById(com.waslla_bank.R.id.tv_date);
        tvTime = view.findViewById(com.waslla_bank.R.id.tv_time);
        btnJoinTrip = view.findViewById(com.waslla_bank.R.id.btn_join_trip);
        btnCancel = view.findViewById(com.waslla_bank.R.id.btn_cancel);
    ...
    private void checkTripStatus() {
        ...
        if (tripDetails.getDriver().getId() == userId) {
            ...
            if (tripDetails.getIsRunning()) {
                ...
                btnJoinTrip.setText(getString(com.waslla_bank.R.string.view_map));
                ...
                btnJoinTrip.setText(getString(com.waslla_bank.R.string.start));
                btnJoinTrip.setVisibility(View.VISIBLE);
            ...
            if (tripDetails.getIsJoined() && tripDetails.getIsRunning()&&tripDetails.isAccepted()) {
                ...
                btnCancel.setVisibility(View.INVISIBLE);
                btnJoinTrip.setText(getString(com.waslla_bank.R.string.join_trip));
                btnJoinTrip.setVisibility(View.VISIBLE);
