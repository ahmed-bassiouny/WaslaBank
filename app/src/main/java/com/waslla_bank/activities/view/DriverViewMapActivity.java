...
import com.waslla_bank.api.apiModel.requests.FinishTripRequest;
...
import com.waslla_bank.utils.DateTimeFormat;
...
import com.waslla_bank.adapter.UserInTripItem;
import com.waslla_bank.api.apiModel.requests.TripDetailsRequest;
...
public class DriverViewMapActivity extends MyToolbar implements OnMapReadyCallback, LocationListener, ItemClickInterface<UserInTrip> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.waslla_bank.R.layout.activity_driver_view_map);
        // init tool bar
        initToolbar("", false);
        addBackImagePrimary();
        addSupportActionbar();
        ...
        // driver view
        // set driver icon
        markerOptions.icon(BitmapDescriptorFactory.fromResource(com.waslla_bank.R.drawable.car_marker));
    ...
    private void findView() {
        ...
        tvNoUser = findViewById(com.waslla_bank.R.id.tv_no_user);
    ...
    public void getItem(final UserInTrip user, final int position) {
        ...
        if (!user.getIsEntered()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                builder = new AlertDialog.Builder(this, com.waslla_bank.R.style.AlertDialogStyle);
            } else {
        ...
        finishTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (adapter == null ||adapter.getItemCount() == 0) {
                    ...
                    AlertDialog.Builder builder;
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        builder = new AlertDialog.Builder(DriverViewMapActivity.this, com.waslla_bank.R.style.AlertDialogStyle);
                    } else {
