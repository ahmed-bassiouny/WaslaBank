...
import com.waslla_bank.activities.controller.CreateRequestController;
...
public class CreateRequestActivity extends MyToolbar {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.waslla_bank.R.layout.activity_create_request);
        // set tool bar
        initToolbar(getString(com.waslla_bank.R.string.create_request), true);
        addBackImage();
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (object.getStartPointText().isEmpty()) {
                    etFrom.setError(getString(com.waslla_bank.R.string.invalid_location));
                } else if (object.getEndPointText().isEmpty()) {
                    etFrom.setError(null);
                    etTo.setError(getString(com.waslla_bank.R.string.invalid_location));
                } else if (object.getDate().isEmpty()) {
                    etFrom.setError(null);
                    etTo.setError(null);
                    Toast.makeText(CreateRequestActivity.this, getString(com.waslla_bank.R.string.invalid_date), Toast.LENGTH_SHORT).show();
                } else if (object.getTime().isEmpty()) {
                    etFrom.setError(null);
                    etTo.setError(null);
                    etTime.setError(getString(com.waslla_bank.R.string.invalid_time));
                } else {
                    etFrom.setError(null);
                    etTo.setError(null);
                    ...
                    getController().createTrip(builderCreateTripRequest, new BaseResponseInterface() {
                        ...
                        public void onSuccess(Object o) {
                            Toast.makeText(CreateRequestActivity.this, getString(com.waslla_bank.R.string.trip_created), Toast.LENGTH_SHORT).show();
                            finish();
                        }
    ...
    private void findView() {
        calendarView = findViewById(com.waslla_bank.R.id.calendarView);
        etFrom = findViewById(com.waslla_bank.R.id.et_from);
        etTo = findViewById(com.waslla_bank.R.id.et_to);
        etTime = findViewById(com.waslla_bank.R.id.et_time);
        btnCreate = findViewById(com.waslla_bank.R.id.btn_create);
