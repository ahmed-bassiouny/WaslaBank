...
import com.waslla_bank.activities.controller.RequestInfoController;
import com.waslla_bank.fragments.view.AboutDriverFragment;
...
import com.waslla_bank.fragments.view.TripDetailsFragment;
import com.waslla_bank.fragments.view.UserTripDetailsFragment;
...
public class RequestInfoActivity extends MyToolbar implements MyObserverInterface<TripDetails> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.waslla_bank.R.layout.activity_request_info);
        initToolbar(getString(com.waslla_bank.R.string.request), true);
        addBackImage();
    ...
    private void findView() {
        ...
        tabLayout = findViewById(com.waslla_bank.R.id.tabs);
        map = findViewById(com.waslla_bank.R.id.map);
